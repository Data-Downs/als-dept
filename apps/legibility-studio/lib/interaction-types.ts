...
export const INTERACTION_TYPE_MAP: Record<
  InteractionType,
  InteractionTypeInfo
> = {
  license: {
    ...
    label: "License",
    description:
      "Prove permission to do something. User applies, service verifies eligibility, then issues or refuses.",
  ...
  register: {
    ...
    label: "Register",
    description:
      "Government needs a list. User submits details and gets registered.",
    example:
      "Voter registration, waste carrier registration, birth registration",
    stateModelTemplate: {
      states: [
        { id: "not-started", type: "initial" },
        { id: "identity-verified" },
  ...
  portal: {
    ...
    label: "Portal",
    description:
      "Multiple services grouped together with persistent accounts. User logs in, navigates, and performs actions.",
    example:
      "Universal Credit journal, Student Loans portal, HMRC personal tax account",
    stateModelTemplate: {
      states: [
        { id: "not-started", type: "initial" },
        { id: "identity-verified" },
  ...
  application: {
    ...
    label: "Application",
    description:
      "Collect information, check eligibility, assess, then make a decision with an outcome.",
  ...
  informational_hub: {
    ...
    description:
      "Help the user understand options and decide what's right. No transactional outcome — may refer to other services.",
    example:
      "Get into teaching, travel advice, Check what you can do if you're being bullied",
    stateModelTemplate: {
      states: [
        { id: "not-started", type: "initial" },
        { id: "browsing" },
  ...
  appointment_booker: {
    ...
    description:
      "Book a slot after other prerequisites are done. Select time, confirm, attend.",
  ...
  task_list: {
    ...
    label: "Task List",
    description:
      "Sequential holistic actions the user works through, often over time. Steps must be completed in order.",
    example:
      "Learn to drive (step-by-step), Access to Work, Set up a limited company",
    stateModelTemplate: {
      states: [
        { id: "not-started", type: "initial" },
        { id: "identity-verified" },
      ...
      transitions: [
        ...
        {
          from: "step-3-complete",
          to: "all-steps-complete",
          trigger: "finish",
        },
        {
          from: "consent-given",
  ...
  payment_service: {
    ...
    description:
      "Verify identity or liability, calculate amount, then pay. Often follows an offline interaction.",
  ...
  benefit: {
    ...
    label: "Benefit",
    description:
      "Income-assessed support. Collect financial circumstances, assess entitlement, set up ongoing payments. Citizen lens: 'Seek support'.",
  ...
  entitlement: {
    ...
    label: "Entitlement",
    description:
      "Statutory right verification. Confirm employer/circumstances, verify entitlement, confirm. Citizen lens: 'Claim a right'.",
  ...
  grant: {
    ...
    label: "Grant",
    description:
      "Funding application with conditions. Apply, submit evidence, accept conditions, await decision. Citizen lens: 'Seek support'.",
  ...
  legal_process: {
    ...
    label: "Legal Process",
    description:
      "Multi-step legal procedure requiring careful pacing, optional legal representation, and witness attestation. Citizen lens: 'Navigate complexity'.",
