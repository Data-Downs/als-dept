...
const AGENTS: Array<{
...
}> = [
  {
    ...
    description: "Checks with you before every step. You stay fully in control.",
  ...
  },
  {
    ...
    description: "Acts on your behalf and handles tasks in the background. Gets things done quickly.",
        ...
        return (
          <button
            ...
            className={`w-full text-left p-4 rounded-card border-2 transition-all touch-feedback ${baseBg} ${
              isSelected ? selectedBorder : `${unselectedBorder} hover:border-gray-300`
            }`}
          >
            ...
            {isDot && (
              <div className="flex items-center gap-1.5 mb-2 px-2.5 py-1.5 rounded-md bg-blue-100/80 w-fit">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#1d70b8" strokeWidth="2" strokeLinecap="round">
            ...
            {isMax && (
              <div className="flex items-start gap-1.5 mb-2 px-2.5 py-1.5 rounded-md bg-amber-100/80 w-fit">
                <svg className="shrink-0 mt-0.5" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#b45309" strokeWidth="2" strokeLinecap="round">
                  <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" />
                  <line x1="12" y1="9" x2="12" y2="13" />
                  <line x1="12" y1="17" x2="12.01" y2="17" />
                </svg>
                <span className="text-xs font-medium text-amber-800">
                  Fast but autonomous — always double-check actions taken on your behalf
                </span>
              </div>
            )}
