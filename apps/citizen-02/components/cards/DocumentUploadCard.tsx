...
export function DocumentUploadCard({
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const data: { extracted: Record<string, string>; summary: string } =
        await res.json();
        ...
        >
          {file ? (
            ...
            <>
              ...
              <span className="text-xs text-govuk-mid-grey">
  ...
  if (phase === "extracting") {
    return (
      <div className="flex flex-col items-center justify-center gap-3 p-8 border border-gray-200 rounded-xl bg-gray-50">
        ...
        <span className="text-sm font-medium text-govuk-dark-grey">
          Reading document...
        </span>
        <span className="text-xs text-govuk-mid-grey">
